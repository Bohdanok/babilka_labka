...
barplot(unlist(top_genre_by_years), main = "The most popular genre by years", xlab="Games count",
        las=1, col=blue_shades, horiz = TRUE, cex.names = 0.6, xlim=c(0, max(top_genre_by_years))
        )
...
barplot(unlist(top_rated_genre_by_years) * 10,
              main = paste("Most rated genres by years(reviews count > ", min_reviews_count, ")"),
              xlab="Rating", las=1, col=blue_shades, horiz = TRUE, cex.names = 0.6, xlim=c(0, 10)
              )
